This repository is a modified version of the code base used in Division 1.2 of Raising the Bar: Redux. References to future entities and other content has been cleaned from the build, as well as minor tweaks discovered since release. Recommended changes to the code base will not be reviewed, unless it is deemed necessary to the safety, stability, or quality of the source.

The rest of this file details how to contribute to the Mapbase project on GitHub:
