...
#define ACHIEVEMENT_RTBR_KILL_CREMATOR		        43
#define ACHIEVEMENT_RTBR_KILL_20_ELITES		        44
#define ACHIEVEMENT_RTBR_KILL_WITH_ALYXGUN			45
#define ACHIEVEMENT_RTBR_SECRET_REVOLVER			46
