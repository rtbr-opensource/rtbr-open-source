...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void C_BaseAnimating::DispatchMagThrow( const char *options )
{
	...
	if (token)
	{
		...
		{
			pModel = "models/weapons/akm/m_akm.mdl";
		}
		else if (Q_stricmp(token, "SMG1") == 0)
		{
			pModel = "models/weapons/smg1/m_smg1.mdl";
		}
		...
		{
			pModel = "models/weapons/pistol/m_pistol.mdl";
		}
		else if (Q_stricmp(token, "ALYXGUN") == 0)
		{
			pModel = "models/weapons/alyxgun/m_alyxgun.mdl";
		}
		else if (Q_stricmp(token, "357") == 0)
		{
			pModel = "models/weapons/357/m_357.mdl";
		}
	}
	...
	QAngle angles;
	GetAttachment(attachmentIndex, origin, angles);

	AngleVectors(angles, &velocity);
	AngularImpulse impulse = AngularImpulse(angles.x, angles.y, angles.z);
...
void C_BaseAnimating::FireEvent( const Vector& origin, const QAngle& angles, int event, const char *options )
{
	...
	case AE_WPN_THROWMAG:
		{
			DispatchMagThrow( options );
			break;
		}
