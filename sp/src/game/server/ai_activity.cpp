...
void CAI_BaseNPC::InitDefaultActivitySR(void) 
{
	...
	ADD_ACTIVITY_TO_SR(ACT_VM_SECONDARYRELOAD);
	...
	ADD_ACTIVITY_TO_SR( ACT_VM_SECONDARYATTACK2 );
	ADD_ACTIVITY_TO_SR( ACT_VM_SECONDARYATTACK3 );
	ADD_ACTIVITY_TO_SR( ACT_VM_SECONDARYATTACK4 );
	...
	// RTB:R
	ADD_ACTIVITY_TO_SR( ACT_VM_CHARGE_INTRO ),
	ADD_ACTIVITY_TO_SR( ACT_VM_CHARGE_LOOP ),
	ADD_ACTIVITY_TO_SR( ACT_VM_CHARGE_OUTRO ),
