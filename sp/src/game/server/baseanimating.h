...
// Controllers.
	...
	// Fire
	virtual void Ignite( float flFlameLifetime, bool bNPCOnly = true, float flSize = 0.0f, bool bCalledByLevelDesigner = false, float flDamageScale = 1.0f );
	virtual void IgniteLifetime( float flFlameLifetime, float flDamageScale = 1.0f );
	...
	void InputIgniteCrem(inputdata_t& inputdata);
