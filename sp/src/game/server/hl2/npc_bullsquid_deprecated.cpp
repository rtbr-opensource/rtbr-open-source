...
#include "ai_motor.h"
#include "ai_squad.h"
#include "npc_bullsquid_deprecated.h"
#include "npcevent.h"
#include "soundent.h"
...
extern ConVar sk_bullsquid_health;
extern ConVar sk_bullsquid_dmg_bite;
extern ConVar sk_bullsquid_dmg_whip;
extern ConVar sk_bullsquid_spit_arc_size;
extern ConVar sk_bullsquid_spit_min_wait;
extern ConVar sk_bullsquid_spit_max_wait;
//=========================================================
...
LINK_ENTITY_TO_CLASS( npc_bullsquid_deprecated, CNPC_Bullsquid_Deprecated );
...
// Save/Restore
//---------------------------------------------------------
BEGIN_DATADESC( CNPC_Bullsquid_Deprecated )
...
// Spawn
//=========================================================
void CNPC_Bullsquid_Deprecated::Spawn()
{
	Precache( );
...
//=========================================================
void CNPC_Bullsquid_Deprecated::Precache()
{
...
// Output : 
//-----------------------------------------------------------------------------
Class_T	CNPC_Bullsquid_Deprecated::Classify( void )
{
...
void CNPC_Bullsquid_Deprecated::IdleSound( void )
{
...
// PainSound 
//=========================================================
void CNPC_Bullsquid_Deprecated::PainSound( const CTakeDamageInfo &info )
{
...
// AlertSound
//=========================================================
void CNPC_Bullsquid_Deprecated::AlertSound( void )
{
...
// DeathSound
//=========================================================
void CNPC_Bullsquid_Deprecated::DeathSound( const CTakeDamageInfo &info )
{
...
// AttackSound
//=========================================================
void CNPC_Bullsquid_Deprecated::AttackSound( void )
{
...
// GrowlSound
//=========================================================
void CNPC_Bullsquid_Deprecated::GrowlSound( void )
{
...
//=========================================================
float CNPC_Bullsquid_Deprecated::MaxYawSpeed( void )
{
	float flYS = 0;
...
//=========================================================
void CNPC_Bullsquid_Deprecated::HandleAnimEvent( animevent_t *pEvent )
{
	switch( pEvent->event )
	{
		case BSQUID_AE_SPIT:
...
int CNPC_Bullsquid_Deprecated::RangeAttack1Conditions( float flDot, float flDist )
{
...
//=========================================================
int CNPC_Bullsquid_Deprecated::MeleeAttack1Conditions( float flDot, float flDist )
{
...
// is valid.
//=========================================================
int CNPC_Bullsquid_Deprecated::MeleeAttack2Conditions( float flDot, float flDist )
{
...
bool CNPC_Bullsquid_Deprecated::FValidateHintType( CAI_Hint *pHint )
{
...
void CNPC_Bullsquid_Deprecated::RemoveIgnoredConditions( void )
{
...
Disposition_t CNPC_Bullsquid_Deprecated::IRelationType( CBaseEntity *pTarget )
{
...
//=========================================================
int CNPC_Bullsquid_Deprecated::OnTakeDamage_Alive( const CTakeDamageInfo &inputInfo )
{
...
//=========================================================
int CNPC_Bullsquid_Deprecated::GetSoundInterests( void )
{
	return	SOUND_WORLD	|
			SOUND_COMBAT	|
		    SOUND_CARCASS	|
...
//=========================================================
void CNPC_Bullsquid_Deprecated::OnListened( void )
{
	AISoundIter_t iter;
...
//========================================================
void CNPC_Bullsquid_Deprecated::RunAI( void )
{
...
// GetSchedule 
//=========================================================
int CNPC_Bullsquid_Deprecated::SelectSchedule( void )
{
	switch	( m_NPCState )
	{
...
//=========================================================
bool CNPC_Bullsquid_Deprecated::FInViewCone( Vector pOrigin )
{
...
//=========================================================
void CNPC_Bullsquid_Deprecated::StartTask( const Task_t *pTask )
{
	switch ( pTask->iTask )
	{
...
// RunTask
//=========================================================
void CNPC_Bullsquid_Deprecated::RunTask( const Task_t *pTask )
{
	switch ( pTask->iTask )
	{
	case TASK_SQUID_HOPTURN:
...
//=========================================================
NPC_STATE CNPC_Bullsquid_Deprecated::SelectIdealState( void )
{
...
AI_BEGIN_CUSTOM_NPC( npc_bullsquid_deprecated, CNPC_Bullsquid_Deprecated )
