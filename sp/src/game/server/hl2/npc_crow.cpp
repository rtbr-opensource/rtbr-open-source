...
void CNPC_Crow::Precache( void )
{
	...
	PrecacheScriptSound( "NPC_Seagull.Alert" );
	PrecacheScriptSound( "NPC_Seagull.Die" );
	PrecacheScriptSound( "NPC_Seagull.Pain" );
	PrecacheScriptSound( "NPC_Seagull.Flap" );

	//Pigeon
	PrecacheScriptSound( "NPC_Pigeon.Idle" );
	PrecacheScriptSound( "NPC_Pigeon.Alert" );
	PrecacheScriptSound( "NPC_Pigeon.Die" );
	PrecacheScriptSound( "NPC_Pigeon.Pain" );
	PrecacheScriptSound( "NPC_Pigeon.Flap" );
}
