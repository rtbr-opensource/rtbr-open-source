...
public:
	...
	{
		EmitSound( "NPC_Seagull.Alert" );
	}

	void FlapSound( void )
	{
		EmitSound( "NPC_Seagull.Flap" );
	}
};
...
public:
	...
	void PainSound( const CTakeDamageInfo &info )
	{
		EmitSound( "NPC_Pigeon.Pain" );
	}

	void DeathSound( const CTakeDamageInfo &info )
	{
		EmitSound( "NPC_Pigeon.Die" );
	}
	...
	void AlertSound( void )
	{
		EmitSound( "NPC_Pigeon.Alert" );
	}
	
	void FlapSound( void )
	{
		EmitSound( "NPC_Pigeon.Flap" );
	}
};
