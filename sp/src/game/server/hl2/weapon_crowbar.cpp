...
void CWeaponCrowbar::OnPickedUp(CBaseCombatCharacter *pNewOwner)
{
...
//-----------------------------------------------------------------------------
// Purpose: Precache the timer for the weapon fidgets.
//-----------------------------------------------------------------------------
...
void CrowbarComplete() {

}
ConCommand meleeattack("+meleeattack", FireSingleCrowbar, "Fires single meele primary attack", 0);
ConCommand meleeattackcancel("-meleeattack", CrowbarComplete);