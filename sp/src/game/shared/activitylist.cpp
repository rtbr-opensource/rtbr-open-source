...
void ActivityList_RegisterSharedActivities( void )
{
	...
	REGISTER_SHARED_ACTIVITY(ACT_VM_SECONDARYRELOAD);
	REGISTER_SHARED_ACTIVITY(ACT_VM_FIRE_IDLE);
	...
	REGISTER_SHARED_ACTIVITY( ACT_VM_SECONDARYATTACK2 );
	REGISTER_SHARED_ACTIVITY( ACT_VM_SECONDARYATTACK3 );
	REGISTER_SHARED_ACTIVITY( ACT_VM_SECONDARYATTACK4 );
	...
	// RTB:R
	REGISTER_SHARED_ACTIVITY( ACT_VM_CHARGE_INTRO );
	REGISTER_SHARED_ACTIVITY( ACT_VM_CHARGE_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_VM_CHARGE_OUTRO );
...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_CROSSBOW_RELAXED );
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_CROSSBOW_STIMULATED );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_CROSSBOW_RELAXED );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROSSBOW_RELAXED );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_CROSSBOW_STIMULATED );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROSSBOW_STIMULATED );
	
	REGISTER_SHARED_ACTIVITY( ACT_IDLE_AIM_CROSSBOW_STIMULATED );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_AIM_CROSSBOW_STIMULATED );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_AIM_CROSSBOW_STIMULATED );
