...
ConVar	sk_plr_dmg_akm			( "sk_plr_dmg_akm", "0", FCVAR_REPLICATED );
...
ConVar  alyx_darkness_force( "alyx_darkness_force", "0", FCVAR_CHEAT | FCVAR_REPLICATED );
	...
	CHalfLife2::CHalfLife2()
	{
		...
		// RTBR - Default behavior is stunstick pickup
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		// For the love of everything holy please please only add new ammo types below the ones already there. Thanks in advance, Iridium. (Custom ammo pickup sounds rely on the positions of the type in
